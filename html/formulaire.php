    ...
    <nav class="navbar is-transparent">
        <div class="navbar-brand">
          <a class="navbar-item" href="#">
            <img width="180" height="140" viewBox="0 0 640 160" src="../images/PhotoCutPasteBackgroundChanger10052019221725.png" alt="Logo Joanna Massage">
        ...
        <div id="navbarExampleTransparentExample" class="navbar-menu">
          <div class="navbar-start">
            <a class="navbar-item" href="#"> Les massages </a>
            <div class="navbar-item has-dropdown is-active">
              <a class="navbar-link" href="#"> Trouver mon professionnel.le </a>
              <div class="navbar-dropdown is-boxed">
                <a class="navbar-item" href="#"> Mon compte Premium </a>
                <a class="navbar-item" href="#"> Me connecter </a>
                <hr class="navbar-divider">
                <a class="navbar-item" href="#">  Me connecter </a>
                <a class="navbar-item is-selected" href="#"> Layout </a>
