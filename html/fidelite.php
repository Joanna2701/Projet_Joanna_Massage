    ...
    <div class="allcontainer">
        ...
        <section class="animate-on-scroll">
            ...
            <div class="avantages">
                ...
                <div class="avantage animate-on-scroll">
                    <img src="../images/massage5.png" alt="Produit Cosmétique">
                    <h3>Produit Cosmétique Offert</h3>
                    <p>Dès le dixième massage réservé, recevez une huile de massage en cadeau.</p>
                </div>
                <div class="avantage animate-on-scroll">
                    <img src="../images/massage.png" alt="Offres Exclusives">
                    <h3>Offres Exclusives</h3>
                    <p>Accédez à des promotions et des offres réservées uniquement aux membres du programme "Cliente Privilège Premium".<img class="lotus" src="../images/fleur-de-lotus.png" style="margin: 20px;" width=30%></p>
                </div>
        </section>
